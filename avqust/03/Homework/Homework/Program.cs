...
{ /*
             ...
             Homework:
              ...
              Bu methodların heç birinin parametririnin tipi Tv, Laptop, object, dynamic və ya .NET'in hər hansısa tipində ola BİLMƏZ! Bunu biraz düşünmək lazım olacaq :)
              ...
              NOT: GƏLƏN DƏRS MÜTLƏQ XATIRLADIN BU TAPŞIRIĞI MƏN EDİM!!!
             */
    class Program
    {
        static void Main(string[] args)
        {
            ...
            laptop1.Barcode = "123456789"; //Xeta cixacaq "Bu barkod daha once basqa mehsul ucun sisteme elave olunub!"

            laptop.Model = "Rog";

            Database.UpdateItem(laptop);
            Database.DeleteDevice(laptop);
